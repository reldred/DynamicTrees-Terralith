...
public class DTTGrowthLogicKits {
    ...
    public static final GrowthLogicKit TWISTING_TREE = new TwistingTreeLogic(DynamicTreesTerralith.location("twisting_tree"));
    public static final GrowthLogicKit VARIATE_HEIGHT = new VariateHeightLogic(DynamicTreesTerralith.location("variate_height"));
